          ...
          if (!this.hasSearchTerm)
            Expanded(
              child: Column(
                ...
                children: <Widget>[
                  SelectPlaceAction(
                      getLocationName(), () => {Navigator.of(context).pop()}, appStateModel.blocks.localeText.tapToSelectThisLocation),
                  Divider(height: 8),
                  Padding(
                    child:
                        Text(appStateModel.blocks.localeText.nearbyPlaces, style: TextStyle(fontSize: 16)),
